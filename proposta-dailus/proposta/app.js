...
(function(){
  ...
  var POSS = {
    ...
    'ocr':{obj:'Melhorar margem',title:'OCR de NF/boletos (back-office)',
      ...
      dailus:'Eficiência administrativa que fala a língua de quem cuida de finanças e operação (ROI).',
      cliente:'(interno) Time financeiro livre do trabalho manual repetitivo.',
      base:'Cultura "AI & Data-Driven" cada vez mais forte na marca; o motor de OCR já existe e está provado.'},
    'painel':{obj:'Melhorar margem',title:'Painel de dados',
      ...
      dailus:'Decisão com dado, do jeito que a marca quer trabalhar.',
      cliente:'Produtos e atendimento que melhoram com base no que ela diz.',
      base:'Cultura data-driven crescente na marca; hoje os dados de conversa estão dispersos.'},
